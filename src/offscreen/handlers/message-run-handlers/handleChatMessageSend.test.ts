...
import { ensureChatForMessage } from "@/offscreen/handlers/message-run-handlers/utils/ensureChatForMessage"
import { generateResponse } from "@/offscreen/handlers/message-run-handlers/utils/generateResponse"
import { notifySidepanel } from "@/offscreen/handlers/message-run-handlers/utils/notifySidepanel"
import {
  createMessageRun,
...
import { handleChatMessageSend } from "./handleChatMessageSend"
...
vi.mock(
  "@/offscreen/handlers/message-run-handlers/utils/ensureChatForMessage",
  () => ({
...
vi.mock(
  "@/offscreen/handlers/message-run-handlers/utils/notifySidepanel",
  () => ({
...
vi.mock(
  "@/offscreen/handlers/message-run-handlers/utils/generateResponse",
  () => ({
