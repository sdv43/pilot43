---
description: Load this instruction when creating/editing/moving React components in project. The instruction provides guidelines for structuring and styling React components.
---
